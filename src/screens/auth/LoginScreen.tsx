            ...
            >
                <Box flex pt={40} >
                    ...
                    >
                        ...
                        <TemplateText color={WHITE} ml={12} semiBold>Continue with Google</TemplateText>
                    </Box>
                    ...
                    <Box mb={30}>
                        ...
                        {
                            !!error && <Error show={!!error} style={styles.generalError}>
                                {error}
                            </Error>
                        }
                    </Box>
                    ...
                    <TemplateText size={16} center style={styles.signupLink} medium color={GREY_70}>
                        Forgot you password?
                        {'  '}
                    ...
                    <Box row justifyContent="center" mb={24} onPress={() => navigation.navigate(ONBOARDING)}>
                        <TemplateText color={GREY_70} size={16}>Don't have an account? </TemplateText>
                        <TemplateText color={SECONDARY} size={16} >Sign up</TemplateText>
                    </Box>
                </Box>
            </Wrapper>
        </Box>
